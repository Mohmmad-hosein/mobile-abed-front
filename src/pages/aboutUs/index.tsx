  ...
  render() {
    return (
      <div className="mt-16 felx flex-wrap justify-center">
        ...
        />
        <h1 className="text-4xl text-[#1A0873] font-bold text-center mb-8">
        ...
        <div className="w-full p-[5%] mb-16 flex flex-wrap justify-between">
          <div className="flex flex-wrap gap-3 justify-center w-[490px]">
            ...
            <FloatingInput
              ...
              textarea
            />
            <button className="w-full h-[68px] bg-[#1A0873] text-white font-black text-2xl rounded-lg mt-10"> ارسال نظر  </button>
          </div>
